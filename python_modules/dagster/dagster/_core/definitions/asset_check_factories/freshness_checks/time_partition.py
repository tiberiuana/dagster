...
from ..utils import (
    ...
    retrieve_latest_parseable_observation_or_materialization,
)
...
def _build_freshness_multi_check(
    ...
    def the_check(context: AssetCheckExecutionContext) -> Iterable[AssetCheckResult]:
        for check_key in context.selected_asset_check_keys:
            ...
            latest_record = retrieve_latest_parseable_observation_or_materialization(
            ...
            latest_record_any_partition = retrieve_latest_parseable_observation_or_materialization(
