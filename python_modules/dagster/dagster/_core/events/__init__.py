...
class DagsterEvent(
    ...
    def job_failure(
        ...
        earliest_step_failure_event: Optional["DagsterEvent"] = None,
    ) -> "DagsterEvent":
        ...
        if isinstance(job_context_or_name, IPlanContext):
            return DagsterEvent.from_job(
                ...
                event_specific_data=JobFailureData(
                    ...
                    earliest_step_failure_event=earliest_step_failure_event,
                ),
            )
        else:
...
class JobFailureData(
    NamedTuple(
        ...
        [
            ...
            ("earliest_step_failure_event", Optional["DagsterEvent"]),
        ],
    )
):
    def __new__(
        ...
        return super(JobFailureData, cls).__new__(
            ...
            earliest_step_failure_event=check.opt_inst_param(
                earliest_step_failure_event, "earliest_step_failure_event", DagsterEvent
            ),
        )
